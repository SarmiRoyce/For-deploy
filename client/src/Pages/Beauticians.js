...
//     const [selectedService, setSelectedService] = useState('');
    ...
    // Fetch services data
    // useEffect(() => {
    //     fetch('http://localhost:3002/services/view') // Adjust the endpoint as necessary
    //         .then(response => response.json())
    //         .then(data => {
    //             if (Array.isArray(data)) {
    //                 setServices(data);
...
//     useEffect(() => {
//         fetch('http://localhost:5000/beauticians')
//             .then(response => response.json())
...
//                                 ))}
//                             </div>
//                             <a href={`/Beauty/${beautician._id}`}><button className='btn12'>View Profile</button></a>
//                         </div>
//                     </div>
//                 ))}
//             </div>
