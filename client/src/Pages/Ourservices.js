...
function Ourservices() {
  return (
    <div className='content'>
        ...
        <a href='/packages'><img src="https://freeonlinedeal.files.wordpress.com/2015/06/parlour-services.jpg" alt="Beauty Parlour and Salon Visits" style={{marginLeft:'700px',marginTop:'20px',borderRadius:'20px'}}/></a><br/><br/><br/>
        <Footer/>
